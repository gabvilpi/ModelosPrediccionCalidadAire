...
#### 1.5.1. Modelo basado en MLP (Multilayer perceptron)
...
#### 1.5.2. Modelo basado en LSTM (Long Short-Term Memory)
...
#### 1.5.3. Modelo basado en CNN (Convolutional Neural Network)
...
#### 1.5.4. Modelo basado en SVM (Support Vector Machines)
