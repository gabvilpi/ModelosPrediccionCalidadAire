...
# ficheros <- list.files(pattern = "ene_mo01.txt")
# ficheros <- list.files(pattern = "oct_mo17")
...
# Boxplot dióxido de nitrógeno NO2
...
A continuación se seleccionan los datos deseados para constuir el modelo de predicción de la calidad del aire. Los datos seleccionados se integraran en un nuevo data frame uniendo todos los datos de una misma fecha. 
...
- Sustituimos el campo festivo por laborable y lo codificamos como 0|1 (festivo = 0, sabado = 0, domingo = 1, laborable = 1)

```{r transformación_normalizacion, warning=FALSE, message=FALSE}

# Sustituimos el campo festivo por laborable
...
- Imputamos a los valores perdidos (NA) el valor de la media aritmética del resto de valores observados

```{r imputación_valores, eval=FALSE, message=FALSE, warning=FALSE, include=FALSE}

for (i in levels(datos$contaminante)) {
  for (j in levels(datos$estacion)) {
    datos$hora1[is.na(datos$hora1) & datos$contaminante==i & datos$estacion==j] <- mean(datos$hora1[datos$contaminante==i & datos$estacion==j], na.rm = TRUE)
    datos$hora2[is.na(datos$hora2) & datos$contaminante==i & datos$estacion==j] <- mean(datos$hora2[datos$contaminante==i & datos$estacion==j], na.rm = TRUE)
    datos$hora3[is.na(datos$hora3) & datos$contaminante==i & datos$estacion==j] <- mean(datos$hora3[datos$contaminante==i & datos$estacion==j], na.rm = TRUE)
    datos$hora4[is.na(datos$hora4) & datos$contaminante==i & datos$estacion==j] <- mean(datos$hora4[datos$contaminante==i & datos$estacion==j], na.rm = TRUE)
    datos$hora5[is.na(datos$hora5) & datos$contaminante==i & datos$estacion==j] <- mean(datos$hora5[datos$contaminante==i & datos$estacion==j], na.rm = TRUE)
    datos$hora6[is.na(datos$hora6) & datos$contaminante==i & datos$estacion==j] <- mean(datos$hora6[datos$contaminante==i & datos$estacion==j], na.rm = TRUE)
    datos$hora7[is.na(datos$hora7) & datos$contaminante==i & datos$estacion==j] <- mean(datos$hora7[datos$contaminante==i & datos$estacion==j], na.rm = TRUE)
    datos$hora8[is.na(datos$hora8) & datos$contaminante==i & datos$estacion==j] <- mean(datos$hora8[datos$contaminante==i & datos$estacion==j], na.rm = TRUE)
    datos$hora9[is.na(datos$hora9) & datos$contaminante==i & datos$estacion==j] <- mean(datos$hora9[datos$contaminante==i & datos$estacion==j], na.rm = TRUE)
    datos$hora10[is.na(datos$hora10) & datos$contaminante==i & datos$estacion==j] <- mean(datos$hora10[datos$contaminante==i & datos$estacion==j], na.rm = TRUE)
    datos$hora11[is.na(datos$hora11) & datos$contaminante==i & datos$estacion==j] <- mean(datos$hora11[datos$contaminante==i & datos$estacion==j], na.rm = TRUE)
    datos$hora12[is.na(datos$hora12) & datos$contaminante==i & datos$estacion==j] <- mean(datos$hora12[datos$contaminante==i & datos$estacion==j], na.rm = TRUE)
    datos$hora13[is.na(datos$hora13) & datos$contaminante==i & datos$estacion==j] <- mean(datos$hora13[datos$contaminante==i & datos$estacion==j], na.rm = TRUE)
    datos$hora14[is.na(datos$hora14) & datos$contaminante==i & datos$estacion==j] <- mean(datos$hora14[datos$contaminante==i & datos$estacion==j], na.rm = TRUE)
    datos$hora15[is.na(datos$hora15) & datos$contaminante==i & datos$estacion==j] <- mean(datos$hora15[datos$contaminante==i & datos$estacion==j], na.rm = TRUE)
    datos$hora16[is.na(datos$hora16) & datos$contaminante==i & datos$estacion==j] <- mean(datos$hora16[datos$contaminante==i & datos$estacion==j], na.rm = TRUE)
    datos$hora17[is.na(datos$hora17) & datos$contaminante==i & datos$estacion==j] <- mean(datos$hora17[datos$contaminante==i & datos$estacion==j], na.rm = TRUE)
    datos$hora18[is.na(datos$hora18) & datos$contaminante==i & datos$estacion==j] <- mean(datos$hora18[datos$contaminante==i & datos$estacion==j], na.rm = TRUE)
    datos$hora19[is.na(datos$hora19) & datos$contaminante==i & datos$estacion==j] <- mean(datos$hora19[datos$contaminante==i & datos$estacion==j], na.rm = TRUE)
    datos$hora20[is.na(datos$hora20) & datos$contaminante==i & datos$estacion==j] <- mean(datos$hora20[datos$contaminante==i & datos$estacion==j], na.rm = TRUE)
    datos$hora21[is.na(datos$hora21) & datos$contaminante==i & datos$estacion==j] <- mean(datos$hora21[datos$contaminante==i & datos$estacion==j], na.rm = TRUE)
    datos$hora22[is.na(datos$hora22) & datos$contaminante==i & datos$estacion==j] <- mean(datos$hora22[datos$contaminante==i & datos$estacion==j], na.rm = TRUE)
    datos$hora23[is.na(datos$hora23) & datos$contaminante==i & datos$estacion==j] <- mean(datos$hora23[datos$contaminante==i & datos$estacion==j], na.rm = TRUE)
    datos$hora24[is.na(datos$hora24) & datos$contaminante==i & datos$estacion==j] <- mean(datos$hora24[datos$contaminante==i & datos$estacion==j], na.rm = TRUE)
  }
}
...
```{r imputación_valores2, message=FALSE, warning=FALSE}
  ...
  for (j in levels(datos$estacion)) {
    for (k in colnames(datos)[4:35]) {
      ...
      if (nrow(datos[temp & datos$contaminante==i & datos$estacion==j,][k]) != 0) {
        datos[temp & datos$contaminante==i & datos$estacion==j,][k] <- mean(datos[[k]], na.rm = TRUE)
      }
    }
  }
}
...
- Normalizamos todas las medidas en un rango [0-1]
